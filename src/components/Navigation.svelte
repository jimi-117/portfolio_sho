...
<nav
  class="fixed bottom-8 left-0 right-0 z-40 flex justify-center md:right-8 md:left-auto md:bottom-auto md:top-1/2 md:-translate-y-1/2 md:flex-col"
>
  <div class="relative">
    <!-- Mobile menu button -->
    <button
    ...
    <div class="md:block {isMenuOpen ? 'block' : 'hidden'}">
      <ul
        class="flex md:flex-col p-2 mt-2 md:mt-0 mb-2 md:mb-0 md:p-0 md:space-y-2 space-x-2 md:space-x-0 bg-white/90 dark:bg-natural-800/90 backdrop-blur-sm md:bg-transparent md:dark:bg-transparent md:backdrop-filter-none rounded-full shadow-lg md:shadow-none"
      >
