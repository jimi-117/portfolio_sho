        ...
        <div class="w-full max-w-3xl mx-auto">
          ...
          <div class="flex mb-8">
            ...
            <div class="flex-1 flex relative">
              {#each monthLabels as { index, month }}
                <div
                  class="text-natural-500 dark:text-natural-400 text-sm absolute"
          ...
          <div class="flex">
            ...
            <div class="w-12 flex flex-col justify-between text-right pr-2">
              <div class="h-3 text-xs text-natural-500 dark:text-natural-400">
                Mon
              </div>
              <div class="h-3 text-xs text-natural-500 dark:text-natural-400">
                Wed
            ...
            <div class="flex-1 flex space-x-1">
              {#each contributionsByWeek as week}
                <div class="flex flex-col space-y-1">
                  {#each week as day}
                    <div
                      class="h-3 w-3 rounded-sm {getContributionColor(
                        day.count
                      )} transition-colors hover:ring-2 ring-natural-400 dark:ring-natural-600"
          ...
          <!-- Legend -->
          <div
            class="flex justify-end mt-4 items-center text-sm text-natural-500 dark:text-natural-400"
          >
            <span class="mr-2">Less</span>
            <div class="flex space-x-1">
              <div
                class="h-3 w-3 rounded-sm bg-natural-200 dark:bg-natural-700"
              ></div>
              <div
                class="h-3 w-3 rounded-sm bg-success-200 dark:bg-success-900"
              ></div>
              <div
                class="h-3 w-3 rounded-sm bg-success-300 dark:bg-success-800"
              ></div>
              <div
                class="h-3 w-3 rounded-sm bg-success-400 dark:bg-success-700"
              ></div>
              <div
                class="h-3 w-3 rounded-sm bg-success-500 dark:bg-success-600"
              ></div>
            </div>
