...
<header
  class="fixed top-0 left-0 right-0 z-50 py-4 transition-all backdrop-blur-sm bg-natural-50/80 dark:bg-natural-900/80 border-b border-natural-200 dark:border-natural-800"
>
  <div class="section-container flex justify-between items-center">
    ...
    <div class="flex items-center space-x-4 sm:space-x-6">
      <span
        class="hidden sm:inline-block text-sm text-natural-600 dark:text-natural-400"
        >{datetime}</span
      >
